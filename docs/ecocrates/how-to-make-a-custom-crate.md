...
The default crates.yml can be found here:

[crates.yml](https://github.com/Auxilor/EcoCrates/blob/master/eco-core/core-plugin/src/main/resources/crates.yml)

## Breakdown of crates.yml

crates.yml is where the configs for all crates are. It may initially seem daunting however it is very easy to configure and make your own crates.

Simply, crates.yml looks like this:
...
It's a big array of objects, each element in the list being a crate. You can add and remove crate by creating and removing elements from the list.

## Typical Crate Config

```yaml
- id: demo # The ID of the crate
