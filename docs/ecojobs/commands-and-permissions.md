...
| `/ecojobs import <id>`                    | Import an jobs from [lrcdb](https://lrcdb.auxilor.io/) | `ecojobs.command.import`             |
| `/ecojobs export <id>`                    | Export an jobs to [lrcdb](https://lrcdb.auxilor.io/)   | `ecojobs.command.export`             |
