...
| `change_town_role`              | Triggered when chaing town role **Requires HuskTowns**                                                            | 1                                             |
...
| `enter_claim`                   | Triggered when entering claimed land **Requires HuskTowns \|\| HuskClaims**                                       | 1                                             |
...
| `leave_claim`                   | Triggered when leaving claimed land **Requires HuskTowns \|\| HuskClaims**                                        | 1                                             |
